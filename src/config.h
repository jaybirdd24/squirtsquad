...
namespace Config {
    ...
    // Test mode: skip the 360 scan and coarse align. Point the robot at the
    // light before power-up; after gyro bias it starts fuzzy approach directly.
    constexpr bool LIGHT_DIRECT_APPROACH_TEST_MODE = true;
